...
var is_bidding_up={
    'true':function(sms_json){
        var is_sign=judge_repeat(Activity.get_activities()[Activity.get_current_activity_id(Activity.get_act_id_by_name(Activity.get_current_activity()))].sign_ups,sms_json.messages[0].phone);
        var is_bid=judge_repeat(Activity.get_activities()[Activity.get_current_activity_id(Activity.get_act_id_by_name(Activity.get_current_activity()))].biddings[Bid.get_current_bid()],sms_json.messages[0].phone)
